...
skin.name = "IronStone"
skin.author = "Georgi \"Jinex\" Trifonov, Berk \"SAS41\" Alyamach"
skin.version = "1.0"

local smallfont = love.graphics.newFont(18)
local imagebuttonfont = love.graphics.newFont(22)
local customfontATComputer = love.graphics.newFont("assets/fonts/ATComputer.ttf", 22)
...
skin.controls.frame_name_color                      = {0, 0, 0, 255}
skin.controls.frame_name_font                       = customfontATComputer
